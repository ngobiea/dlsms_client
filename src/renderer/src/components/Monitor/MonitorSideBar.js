...
const MonitorSideBar = () => {
  return (
    <aside className="fixed top-0 left-0 z-40 w-72 h-screen pt-8 pr-6 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0">
